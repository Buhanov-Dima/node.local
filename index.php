...
<section id="block-2" data-stellar-background-ratio="0.2">
	<div class="container">
		<div class="row">
			<div class="col">
		...
		<div class="row no-gutters">
			<div class="col-xl-3 col-md-4">
				<div id="par-1" class="news news1 wrap-b2-txt"  data-stellar-background-ratio="0.5">
				...
				<div id="par-2" class="news news2 wrap-b2-txt" data-stellar-background-ratio="1">
					<h6>High efficiency</h6>
					<p>Energy transmission with 95% efficiency.</p>
				</div>
				<div id="par-3" class="news news3 wrap-b2-txt" data-stellar-background-ratio="1.5">
					<h6>Long distance</h6>
