...
<section id="block-2" data-paroller-factor="0.1" data-paroller-type="foreground" data-paroller-direction="vertical">
	<div class="container">
		...
		<div class="row no-gutters">
			...
			<div class="col-xl-3 col-md-4">
				<div id="par-4" class="news-r news-r1 wrap-b2-txt" data-paroller-factor="0.2" data-paroller-type="foreground" data-paroller-direction="vertical">
				...
				<div id="par-5" class="news-r news-r2 wrap-b2-txt" data-paroller-factor="0.2" data-paroller-type="foreground" data-paroller-direction="vertical">
