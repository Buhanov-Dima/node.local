		...
		<div class="col-xl-12">
			...
			<div class="team">
				<div class="man">
					...
					<span>Founder</span>
					<p>Master of Engeneering, Electronics <br>and Communication Systems. Many years of<br>R&D experience in electricity storage and<br>transmission, new ceramic materials.</p>
				</div>
				<div class="man">
				...
				<div class="man">
					...
					<p class="team-name">George Mikaberydze</p>
					<span>Business Development</span>
					<p>CEO and Co-Founder of the 100AM. Previously, Co-Founder and Managing Director of Healbe - the company-developer of wearable devices. More than 10 years of experience in media (RBC, Hearst Shkulev Media) in marketing, business development and launching new projects. Top 5 Marketing Director in Russia (according to Kommersant rating in 2009-2010).</p>
				</div>
				<div class="man">
